        ...
        >
            ...
            <div className="w-full h-full bg-white shadow-lg rounded-lg px-5 pt-5 pb-8 lg:h-full lg:px-7 lg:text-center md:text-center">
                ...
                <div className=" w-full mt-2 text-center lg:px-20">
                    ...
                    >
                        Fabric Manufacturing Location
                    </label>
                    <div className="flex justify-center">
                        <div className="w-full inline-flex h-12">
                            <input
                                onChange={(e) =>
                                    setFabricLocation(e.target.value)
                                }
                                type="text"
                                placeholder="Location where fabric was manufactured"
                    ...
                    <div className="flex justify-center">
                        <div className="w-full inline-flex h-12">
                            <input
                                ...
                                type="text"
                                placeholder="Amount of electricity used"
                                className="focus:border-blue-900 rounded-lg border outline-0 border-gray-300 text-gray-900 text-xs font-prints block flex-1 min-w-0 w-full text-xs border-gray-300 p-2.5 "
                            />
                        </div>
                    </div>
                ...
                <div className="h-48 w-full mt-2 text-center lg:px-20">
                    ...
                    <div
                        ...
                        style={{ border: "dashed 1px lightgray" }}
                    >
                        <div className="w-full h-32 inline-flex h-12">
                            <div className="box-border w-full p-4 items-center self-center">
                                <div className="items-center flex-col flex w-full tracking-tighter text-gray-400">
                                    {" "}
                                    <svg
                                        className="w-8 h-8"
                                        fill="lightgray"
