    ...
    return (
        <div className="flex-col flex pt-7 px-4 lg:pb-10 pb-28 bg-teal bg-cover lg:px-10" style={{ backgroundPosition: "left top" }}>
            ...
            <div className="w-full h-full bg-white shadow-lg rounded-lg px-5 pt-5 pb-8 lg:h-full lg:px-7 lg:text-center md:text-center">
                <h3 className="font-header text-xl tracking-tighter mb-1 text-black-900 lg:text-2xl lg:pt-2">Batch Information  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="cursor-pointer ml-0.5 mb-0.5 item-center inline bi bi-question-circle-fill" viewBox="0 0 16 16">
                    <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM5.496 6.033h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286a.237.237 0 0 0 .241.247zm2.325 6.443c.61 0 1.029-.394 1.029-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94 0 .533.425.927 1.01.927z" />
                </svg></h3>
                <p className="text-black-800 text-xs tracking-tighter leading-none font-prints lg:text-sm">Review the information provided by your supplier(s).</p>
                <div className="w-full text-center lg:px-20 mt-6">
                    <label htmlFor="website-admin" className="block mb-1 font-semibold text-black-900 tracking-tighter text-left">Batch identifier</label>
                    <p className="outline-0 text-gray-900 text-xs font-prints block flex-1 min-w-0 w-full text-left" >{result ? batchNo : <Skeleton paragraph={{rows: 0}} active/>}</p>
                </div>
                ...
                <div className=" w-full mt-2 text-center lg:px-20">
                    <button className=" w-full lg:px-20 h-12 bg-blue-900 font-header tracking-tighter mt-3 inline-flex mb-5 items-center justify-center text-white focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm text-center">
